...
| `ste-editor` | you rewrite prose under `docs/spec/`, `docs/decisions/`, `docs/evaluations/`, `docs/obligations/`, `docs/interfaces/` or `docs/tutorials/` |
