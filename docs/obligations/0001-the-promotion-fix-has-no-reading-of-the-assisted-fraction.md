...
Two capture rates are worth keeping beside it, because they are what spec 2 says the reading is for. `traces_to` stands at 80.7% of its 176 eligible documents and `governs` at 0.6% of the same 176. Both declare `created_by: hook`, and [OBL-repo-0105](0105-nothing-plays-the-hook-role-that-two-relations-name.md) records that nothing plays that role, so every half of both is hand entry. That is 80 points of spread inside one declared creator and one authoring route.
