...
summary: "hw-run-policy names worktree isolation for hw-build and hw-verify, but next-run.md passes none, and both agent files still make their own tree with new-worktree.sh. No fixture holds the isolation."
