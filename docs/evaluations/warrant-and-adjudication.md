...
| Asserted content is promoted rather than accumulated | the promotion rate per quarter in `taxonomy audit`, against the count of asserted documents | unmeasured, and no corpus has any |
...
| [Spec 2](../spec/02-taxonomy-model.md#the-eleven-declarations) | The count stays at eleven. A snapshot pin is an anchor resolver, and a transcription is a projection |
