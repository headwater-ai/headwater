...
19 documents on this shelf, in the reading order this corpus derives.
...
- [n8n as a worked instance — a corpus with no docs root](n8n-worked-example.md) — Eleven real governing documents from n8n, typed against two entries of the library, and what two runs and one coherence sweep found in a corpus that keeps its prose beside the code. (asserted, and no human has accepted it)
