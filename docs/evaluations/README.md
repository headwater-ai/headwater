...
20 documents on this shelf, in the reading order this corpus derives.
...
- [n8n as a worked instance — a corpus with no docs root](n8n-worked-example.md) — Forty-six real governing documents from n8n, typed against three entries of the library, and what three runs and one coherence sweep found in a corpus that keeps its prose beside the code. (asserted, and no human has accepted it)
