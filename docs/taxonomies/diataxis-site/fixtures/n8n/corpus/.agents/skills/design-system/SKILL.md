...
id: N8N-HOW-design-system
status: current
status_since: 2026-09-01
last_verified: 2026-09-01
summary: "Guidelines on using Design System styles and components. Use when working on .vue files in packages/frontend. Triggers for tasks that include component architecture, styling, UI changes, or feature work."
provenance:
  warrant: asserted
  agency: mixed
