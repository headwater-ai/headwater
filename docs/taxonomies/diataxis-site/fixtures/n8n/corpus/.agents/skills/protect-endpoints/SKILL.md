...
id: N8N-HOW-protect-endpoints
status: current
status_since: 2026-09-01
last_verified: 2026-09-01
summary: "Applies n8n's RBAC scope decorators to REST endpoints. Use when creating a new @RestController, adding any @Get/@Post/@Put/@Patch/@Delete route to an existing controller, or reviewing endpoint authorization. Every authenticated endpoint must be gated by @ProjectScope or @GlobalScope."
provenance:
  warrant: asserted
  agency: mixed
