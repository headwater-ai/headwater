...
# .agents/skills/community-pr-readiness-check/reference/label-flow.md
id: N8N-HOW-community-pr-readiness-check-reference-label-flow
status: current
status_since: 2026-09-01
last_verified: 2026-09-01
summary: "Community PR Readiness Check \u2014 triage label flow"
provenance:
  warrant: asserted
  agency: mixed
