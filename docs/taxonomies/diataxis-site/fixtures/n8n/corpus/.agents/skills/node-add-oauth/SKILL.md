...
id: N8N-HOW-node-add-oauth
status: current
status_since: 2026-09-01
last_verified: 2026-09-01
summary: "Add OAuth2 credential support to an existing n8n node \u2014 creates the credential file, updates the node, adds tests, and keeps the CLI constant in sync. Use when the user says /node-add-oauth."
provenance:
  warrant: asserted
  agency: mixed
