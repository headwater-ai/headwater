...
id: N8N-HOW-create-issue
status: current
status_since: 2026-09-01
last_verified: 2026-09-01
summary: "Create Linear tickets or GitHub issues following n8n conventions. Use when the user asks to create a ticket, file a bug, open an issue, or says /create-issue."
provenance:
  warrant: asserted
  agency: mixed
