...
id: N8N-HOW-reproduce-bug
status: current
status_since: 2026-09-01
last_verified: 2026-09-01
summary: "Reproduce a bug from a Linear ticket with a failing test. Expects the full ticket context (title, description, comments) to be provided as input."
provenance:
  warrant: asserted
  agency: mixed
