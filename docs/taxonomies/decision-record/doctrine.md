...
- **A facet requirement list.** The same rule stops `title` from reaching the design-spec kinds, which is where #123 measured its absence. HW-DR-0044 did not close this one either.
