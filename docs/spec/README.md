...
- [REG-HW-decisions](09-decisions.md) — An index of the twenty-one design decisions and the one that the build raised, where the record of each one lives, and the evidence that closed it.
