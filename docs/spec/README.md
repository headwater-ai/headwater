...
- [Open questions, closed and redirected](09-open-questions.md) — One heading for each of the 66 documents on the `decisions` shelf, so that a citation naming one of them resolves in this file.
