...
What the decisions leave open is in [13 — Open obligations](13-open-obligations.md). That file is an index of the same shape as this one. Each of its 124 items is a document on [the obligations shelf](../obligations/), and each one names the decision or the specification that produced it.
