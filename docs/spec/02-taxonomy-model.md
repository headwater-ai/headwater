...
A taxonomy is one logical document. The engine assembles it from a base package plus zero or more overlays, and it resolves to a single validated object. The form below is YAML, for illustration. The binding decision is deferred (see [open questions](09-open-questions.md)).
