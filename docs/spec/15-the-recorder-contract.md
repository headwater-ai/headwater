...
summary: Everything an external recorder writes into a transcript, and the closed key sets that refuse a file. It also names the one member of the run identity this engine compares, and the period a result stays citable.
