...
**This record rules on denotation alone.** [HW-DR-0083](0083-governs-and-traces-to-are-created-by-an-agent-because-a-session-proposes-the-line-and-a-person-types-it.md) rules on the actor: `governs` is `created_by: agent`, because a session proposes the line and a person types it. The evaluation above carries a design for that proposal, and the design is not a ruling.
