...
`headwater` dispatches 23 verbs. 23 of them have a contract on this shelf, and 0 have none.
...
| `change` | write the manifest that `check --change` reads | `headwater change` | [headwater change](headwater-change.md) |
