...
`.githooks/change-manifest` is the caller this repository's own commit gate and CI job use. It resolves the built engine and hands its two arguments to this verb. It runs no git command of its own.
