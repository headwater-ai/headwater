...
summary: The deep-agent architecture of Instance AI, from the chat surface through the orchestrator to the tools, the memory system and the detached background agent.
