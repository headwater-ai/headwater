...
Prose under `docs/spec/`, `docs/decisions/`, `docs/evaluations/`, `docs/obligations/`, `docs/interfaces/` and `docs/tutorials/` answers to the `ste_house` language regime. Invoke the `ste-editor` skill for the rules that no check reads.
