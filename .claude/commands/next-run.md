...
**Token discipline is the same list read for cost.** Each entry below was measured across 80 iterations, and each is worth more than it looks, because a result rides every turn that follows it.
