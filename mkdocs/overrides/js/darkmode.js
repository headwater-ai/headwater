 ...
 *
 *       python3 tools/site/check-site-console.py   ->  exit 1
 *       325 pages with a finding, out of 333 served pages
 *
 *   `mkdocs build --strict`, `tools/site/assemble-site.sh --check` and
 *   `tools/site/check-site-fragments.py` each exit 0 over that same tree.
 ...
 *   query.
 *
 * `tools/site/site-console-fixtures.sh` holds it: one case puts the theme's
