...
#
#   tools/engine/dev-fast-build-setup.sh          # install the block
#   tools/engine/dev-fast-build-setup.sh --remove # remove exactly that block
...
# Written by tools/engine/dev-fast-build-setup.sh — remove with --remove.
[target.$host_triple]
